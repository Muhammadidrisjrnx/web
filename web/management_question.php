...
<!-- <div class="w3-content" style="max-width:1100px"> -->
  ...
  <div class="w3-container w3-padding-64" id="contact">
    <h1>Masukkan Pertanyaan Kamu</h1><br>
    ...
    <form action="save_question.php" target="" method="POST">
      ...
      <p><button class="w3-button w3-light-grey w3-section" type="submit">SIMPAN PERTANYAAN</button></p>
    </form>
  ...
  <div class="w3-container w3-padding-64" id="contact">
    ...
    while($row=mysqli_fetch_array($result)){
      ...
      <td>
      <a href='delete_question.php?id=".$row['id']."'>Hapus</a>
      </td>
      </tr>
      ";
    } 
