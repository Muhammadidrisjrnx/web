...
$sql_check = ("SELECT * FROM table_treatment WHERE treatment_option='$treatment'");
...
if (mysqli_num_rows($check)>0) {
    ...
    $sql = ("INSERT INTO table_treatment(treatment_option,created_at,updated_at) VALUES('$treatment','$created_at','$updated_at')");
